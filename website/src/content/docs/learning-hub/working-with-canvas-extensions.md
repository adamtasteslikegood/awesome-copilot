...
- **GitHub Copilot app** — the primary canvas authoring environment, with a visual panel
- **GitHub Copilot CLI** (v1.0.71+) — canvas interactions driven by extensions directly from the terminal
